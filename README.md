...
The application uses [T-Invest API](https://developer.tbank.ru/invest/intro/intro) and [Invest Python gRPC client](https://opensource.tbank.ru/invest/invest-python).
...
- [Invest Python gRPC client](https://opensource.tbank.ru/invest/invest-python)
